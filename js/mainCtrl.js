angular.module('itunes').controller('mainCtrl', function($scope, itunesService){
  ...
  //First inject itunesService into your controller. (DONE)
...
$scope.getSongData = function(){
  ...
  //ng-grid is expecting. What you need to do now is sort the data you got back. This sounds like a great job for a service! Head back
  // to your itunesService and complete the last instructions there.
  ...
  //Now that your service is doing the heavy lifting (sorting/formatting), we can now put the result of calling that method onto
  // $scope.songData so that ng-grid will find it and populate the page.
